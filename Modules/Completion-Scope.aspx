<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="Completion-Scope.aspx.cs" Inherits="FruitUnitedMobile.Modules.Completion_Scope" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container TitleDiv" >
        <div>
            <asp:Label runat="server" Text="Project : " Font-Bold="true" AssociatedControlID="txtProject"></asp:Label>
                    ...
                    <asp:GridView ID="InvoiceGrid" runat="server" AutoGenerateColumns="false" OnRowDataBound="InvoiceGrid_RowDataBound" CssClass="table table-bordered table-responsive">
                        <columns>
                            <asp:TemplateField HeaderText="SN">
                                <itemtemplate>
                                    <div id="linkBtnDiv">
                                        <asp:Label ID="Label12" Text='<%# Bind("S_N") %>' Font-Size="Small" runat="server"></asp:Label>
                                    </div>
                                </itemtemplate>
                            ...
                            <asp:TemplateField HeaderText="Qty">
                                <itemtemplate>
                                    <div id="linkBtnDiv">
                                        <asp:Label ID="Label10" Text='<%# Bind("Qty") %>' Font-Size="Small" runat="server"></asp:Label>
                                    </div>
                                </itemtemplate>
                                <itemstyle horizontalalign="Center" verticalalign="Middle"></itemstyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="(%)">
                                <itemtemplate>
                                    <div id="linkBtnDiv">
                                        <asp:Label ID="Label9" Text='<%# Bind("Completion_Percent") %>' Font-Size="Small" runat="server"></asp:Label>
                                    </div>
                                </itemtemplate>
                                <itemstyle horizontalalign="Center" verticalalign="Middle"></itemstyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Task">
                                <itemtemplate>
                                    <div id="linkBtnDiv">
                                        <asp:LinkButton ID="ViewInvoice" runat="server">
