<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="Completion-Project.aspx.cs" Inherits="FruitUnitedMobile.Modules.Completion_Project" %>
                    ...
                    <asp:GridView ID="InvoiceGrid" runat="server" AutoGenerateColumns="false" OnRowDataBound="InvoiceGrid_RowDataBound" CssClass="table table-bordered table-responsive">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Scope">
                                <ItemTemplate>
                                    <div id="linkBtnDiv">
                                        <asp:LinkButton ID="ViewInvoice" runat="server"><i class="fa fa-search" aria-hidden="true"></i></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="File">
                                <ItemTemplate>
                                    <div id="linkBtnDiv">
                                        <asp:LinkButton ID="ViewFile" runat="server"><i class="fa fa-file-o" aria-hidden="true"></i></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%"></ItemStyle>
                            </asp:TemplateField>
