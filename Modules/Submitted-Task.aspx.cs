...
{
    public partial class Submitted_Task : System.Web.UI.Page
    {
...
WHERE completion.Verified_On IS NULL											
		AND task.Project_Scope_ID = @Project_Scope_ID AND completion.Employee_Profile_ID = @empID
{filterCondition}	
		...
		AND task.Project_Scope_ID = {0}			
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (linkButton != null)
                {
                    ...
                    linkButton.PostBackUrl = $"~/Modules/Submitted-Completion.aspx?Project_Scope_Task_ID={projectScopeTaskId}&Project_Scope_ID=" + Request.QueryString["Project_Scope_ID"] + "&Project_ID=" + Request.QueryString["Project_ID"] + "&Project_Task_Completion_ID=" + projectTaskId;
                }
