...
{
    public partial class Verification_Project : System.Web.UI.Page
    {
...
WHERE Project.Status IN ('Open','Ongoing')										
	...
	INNER JOIN Project_Scope ON Project_Scope.Project_Scope_ID = Project_Scope_Task.Project_Scope_ID WHERE Project_Scope.Project_ID = Project.Project_ID AND Project_Task_Completion.Verified_On IS NULL) > 0									        
        {filterCondition}";
        ...
        protected void InvoiceGrid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lb.PostBackUrl = "~/Modules/Verification-Subcon.aspx?Project_ID=" + ((Label)e.Row.Cells[2].FindControl("Project_ID")).Text;
