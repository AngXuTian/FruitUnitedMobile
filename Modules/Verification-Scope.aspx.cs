...
{
    public partial class Verification_Scope : System.Web.UI.Page
    {
...
WHERE 	Project_Scope.Project_ID = @Project_ID										
	...
	WHERE Project_Scope_Task.Project_Scope_ID = Project_Scope.Project_Scope_ID AND Project_Task_Completion.Verified_On IS NULL) > 0									
    ...
    ", filterQuery);
        ...
        protected void InvoiceGrid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lb.PostBackUrl = "~/Modules/Verification-Task.aspx?Project_ID=" + Request.QueryString["Project_ID"] + "&Project_Scope_ID=" + ((Label)e.Row.Cells[4].FindControl("Project_Scope_ID")).Text;
