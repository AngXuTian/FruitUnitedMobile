<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="Verification-Task.aspx.cs" Inherits="FruitUnitedMobile.Modules.Verification_Task" %>
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Completion Info">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="Label7" Text='<%# "   On: " + Eval("Completion_Date") %>' Visible='<%# !string.IsNullOrEmpty(Eval("Completion_Date")?.ToString()) %>' Font-Size="Small" runat="server"></asp:Label>
