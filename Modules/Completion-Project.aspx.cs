...
{
    public partial class Completion_Project : System.Web.UI.Page
    {
        ...
        {
            string filterCondition = "WHERE Project.Status IN ('Open','Ongoing')";
        ...
        protected void InvoiceGrid_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                LinkButton ViewInvoicelb = (LinkButton)e.Row.Cells[1].FindControl("ViewInvoice");
                ViewInvoicelb.PostBackUrl = "~/Modules/Completion-Scope.aspx?Project_ID=" + ((Label)e.Row.Cells[3].FindControl("Project_ID")).Text;

                LinkButton ViewFilelb = (LinkButton)e.Row.Cells[2].FindControl("ViewFile");
                ViewFilelb.PostBackUrl = "~/Modules/Completion-Project-ViewFile.aspx?Project_ID=" + ((Label)e.Row.Cells[3].FindControl("Project_ID")).Text;
            }
        }
