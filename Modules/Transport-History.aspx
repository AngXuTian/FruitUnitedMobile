<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="Transport-History.aspx.cs" Inherits="FruitUnitedMobile.Modules.Transport_History" %>
    ...
    <div class="container">
        <div id="search-container" class="row" style="display: none;">
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="VehicleTextBox" runat="server" CssClass="form-control FilterTextBox" Placeholder="Search by Vehicle No"></asp:TextBox>
                </div>
                <div class="col-md-3">
                    <asp:TextBox ID="ProjectTextBox" runat="server" CssClass="form-control FilterTextBox" Placeholder="Search by Project"></asp:TextBox>
                </div>
            </div>
            <div class="row">
        ...
        <div class="row" style="margin-top: 10px;">
            <div class="col-12" id="OutputGridDiv" style="overflow: auto;">
                <asp:Panel ID="GridPanel" runat="server" ScrollBars="Vertical" Style="max-height: 65vh; overflow: auto; width: 100%;">
                    <asp:GridView ID="DriverGrid" runat="server" AutoGenerateColumns="false" OnRowDataBound="DriverGrid_RowDataBound" CssClass="table table-bordered table-responsive">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Vehicle">
                                <ItemTemplate>
                                    <asp:Label ID="LabelVehicle" Text='<%# Bind("Vehicle_No") %>' Font-Size="Small" runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
