<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="Submitted-Completion.aspx.cs" Inherits="FruitUnitedMobile.Modules.Submitted_Completion" %>
        ...
        <div class="container" style="border:2px solid black; width:95%; overflow-x: hidden; background-color: white;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td class="label-column"><asp:Label runat="server" ID="txtTools"></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label runat="server" ID="txtCompletedQty"></asp:Label>
                        <asp:Label runat="server" Style="margin-left:15px;" Font-Bold="true" Text="(%):"></asp:Label>
                        <asp:Label runat="server" ID="txtCompletedPercentage"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
