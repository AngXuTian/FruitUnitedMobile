<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="Completion-Project-ViewFile.aspx.cs" Inherits="FruitUnitedMobile.Modules.Completion_Project_ViewFile" %>
                ...
                <div id="GridDiv" class="container" style="height: 200px;">
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-12" id="OutputGridDiv" style="overflow: auto;">
                            <asp:GridView ID="ViewFileGrid" runat="server" AutoGenerateColumns="false" OnRowDataBound="PorjectFileGrid_RowDataBound" CssClass="table table-bordered table-responsive">
                                <Columns>
