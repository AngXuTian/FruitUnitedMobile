...
{
    public partial class GRTN_Project : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Session["GRTN_Project_ID"] = string.Empty;
                BindProjectData("","","");
            }
        }
	...
	ORDER BY Project.Estimated_Start_Date ASC									
        ...
        protected void ProjectGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewLocation")
            {
                ...
                Session["GRTN_Project_ID"] = values[0].Trim();
                Session["GRTN_Quotation_ID"] = values[1].Trim();
                Response.Redirect("~/Modules/GRTN-Location.aspx");
            }
        }
    }
}