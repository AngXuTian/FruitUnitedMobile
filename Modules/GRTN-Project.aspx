<%@ Page Title="" Language="C#" MasterPageFile="~/ModulesPage.Master" AutoEventWireup="true" CodeBehind="GRTN-Project.aspx.cs" Inherits="FruitUnitedMobile.Modules.GRTN_Project" %>
                    ...
                    <asp:GridView ID="ProjectGrid" runat="server" AutoGenerateColumns="false" OnRowDataBound="ProjectGrid_RowDataBound" OnRowCommand="ProjectGrid_RowCommand" CssClass="table table-bordered table-responsive">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <div id="linkBtnDiv">
                                        <asp:LinkButton ID="ViewLocation" runat="server" CommandName="ViewLocation" CommandArgument='<%# Eval("Project_ID") +","+Eval("Quotation_ID") %>'><i class="fa fa-external-link" aria-hidden="true"></i></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
