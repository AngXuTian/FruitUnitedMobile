...
function CollectionCylinderListRadioSelect(Radio) {
    ...
    document.getElementById('ContentPlaceHolder1_ButtonCheckList').disabled = false;
}
...
function ValidateBarcode() {
    ...
    if (BarcodeTB.length < 1)
        { document.getElementById('ContentPlaceHolder1_ButtonRefill').disabled = true; }
    else
        { document.getElementById('ContentPlaceHolder1_ButtonRefill').disabled = false; }
}
